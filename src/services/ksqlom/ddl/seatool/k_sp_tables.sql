...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Action_Officers
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.Action_Officers',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Action_Types
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.Action_Types',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_aspnet_Users
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.aspnet_Users',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Call_Held_Reasons
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.Call_Held_Reasons',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Code_After_Init_Assess
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.Code_After_Init_Assess',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Components
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.Components',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Components_StatePlans
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.Components_StatePlans',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Early_Alert_Fields
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.Early_Alert_Fields',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_EmailDistribution
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.EmailDistribution',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Email
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.Email',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_OCD_Review
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.OCD_Review',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Position
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.Position',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Priority_Codes
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.Priority_Codes',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Priority_Complexity
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.Priority_Complexity',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Priority_Review_Position
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.Priority_Review_Position',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_RAI
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.RAI',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Region
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.Region',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Region_Access
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.Region_Access',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Officers
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.Officers',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_SPA_Type
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.SPA_Type',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_State_Plan_1115
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.State_Plan_1115',KEY_FORMAT='JSON') AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_State_Plan_APD
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.State_Plan_APD',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_State_Plan_APD_Sub_Type
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.State_Plan_APD_Sub_Type',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Early_Alert_Field_Types
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.Early_Alert_Field_Types',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_State_Plan_Early_Alerts
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.State_Plan_Early_Alerts',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_State_Plan_Impact_Funding
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.State_Plan_Impact_Funding',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_States
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.States',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Stop_Resume_Dates
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.Stop_Resume_Dates',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Sub_Type
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.Sub_Type',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Title_Type
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.Title_Type',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Type
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.Type',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_State_Plan_Service_Types
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.State_Plan_Service_Types',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_State_Plan_Service_SubTypes
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.State_Plan_Service_SubTypes',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_State_Plan
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.State_Plan',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
