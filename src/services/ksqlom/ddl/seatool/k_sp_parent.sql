...
CREATE TABLE IF NOT EXISTS K_seatool_tld_SP_ActionTypes
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.SP_ActionTypes',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_agg_Action_Types
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.agg.Action_Types',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT sp.ID_Number,
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_SP_CallHeldReasons
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.SP_CallHeldReasons',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT payload->after->ID_Number,
...
CREATE TABLE IF NOT EXISTS K_seatool_agg_CallHeldReasons
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.agg.CallHeldReasons',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT sp.ID_Number,
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_SP_Code_After_Init_Assess
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.SP_Code_After_Init_Assess',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT payload->after->ID_Number,
...
CREATE TABLE IF NOT EXISTS K_seatool_agg_Code_After_Init_Assess
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.agg.Code_after_init_assess',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT sp.ID_Number,
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_SP_Components
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.SP_Components',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT payload->after->ID_Number,
...
CREATE TABLE IF NOT EXISTS K_seatool_agg_Components
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.agg.Components',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT sp.ID_Number,
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_SP_OCD_Review
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.SP_OCD_Review',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT payload->after->ID_Number,
...
CREATE TABLE IF NOT EXISTS K_seatool_agg_OCD_Review
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.agg.OCD_Review',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT sp.ID_Number,
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_SP_Officers
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.SP_Officers',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT payload->after->ID_Number ,
...
CREATE TABLE IF NOT EXISTS K_seatool_agg_RO_Analyst_Officers
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.agg.RAnalyst_Officers',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT sp.ID_Number,
...
CREATE TABLE IF NOT EXISTS K_seatool_agg_Program_Analyst_Officers
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.agg.ProgramAnalyst_Officers',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT sp.ID_Number,
...
CREATE TABLE IF NOT EXISTS K_seatool_agg_FM_Analyst_Officers
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.agg.FM_Analyst_Officers',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT sp.ID_Number,
...
CREATE TABLE IF NOT EXISTS K_seatool_agg_Lead_Analyst_Officers
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.agg.Lead_Analyst_Officers',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT sp.ID_Number,
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_SP_PriorityCodes
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.SP_PriorityCodes',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT payload->after->ID_Number,
...
CREATE TABLE IF NOT EXISTS K_seatool_agg_Priority_Codes
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.agg.Priority_Codes',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT sp.ID_Number,
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_SP_PriorityComplexity
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.SP_PriorityComplexity',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT payload->after->ID_Number,
...
CREATE TABLE IF NOT EXISTS K_seatool_agg_Priority_Complexity
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.agg.Priority_Complexity',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT sp.ID_Number,
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_SP_PriorityReviewPosition
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.SP_PriorityReviewPosition',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT payload->after->ID_Number,
...
CREATE TABLE IF NOT EXISTS K_seatool_agg_Review_Position
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.agg.Review_Position',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT sp.ID_Number,
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_SP_Region
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.SP_Region',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT payload->after->ID_Number,
...
CREATE TABLE IF NOT EXISTS K_seatool_agg_Region
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.agg.Region',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT sp.ID_Number,
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_SP_States
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.SP_States',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT payload->after->ID_Number,
...
CREATE TABLE IF NOT EXISTS K_seatool_agg_States
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.agg.States',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT sp.ID_Number,
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_SP_Type
 WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.tld.SP_Type',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
 SELECT payload->after->ID_Number,
