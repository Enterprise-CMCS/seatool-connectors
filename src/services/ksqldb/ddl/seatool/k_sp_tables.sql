...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Action_Officers
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.Action_Officers',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Action_Types
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.Action_Types',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_aspnet_Users
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.aspnet_Users',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Call_Held_Reasons
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.Call_Held_Reasons',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Code_After_Init_Assess
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.Code_After_Init_Assess',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Components
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.Components',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Components_StatePlans
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.Components_StatePlans',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Early_Alert_Fields
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.Early_Alert_Fields',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_EmailDistribution
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.EmailDistribution',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Email
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.Email',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_OCD_Review
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.OCD_Review',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Officers
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.Officers',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Plan_Types
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.Plan_Types',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Position
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.Position',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Priority_Codes
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.Priority_Codes',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Priority_Complexity
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.Priority_Complexity',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Priority_Review_Position
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.Priority_Review_Position',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_RAI
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.RAI',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Region
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.Region',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Region_Access
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.Region_Access',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_SPA_Type
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.SPA_Type',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_SPW_Status
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.SPW_Status',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_State_Plan_1115
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.State_Plan_1115',KEY_FORMAT='JSON') AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_State_Plan_APD
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.State_Plan_APD',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_State_Plan_APD_Sub_Type
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.State_Plan_APD_Sub_Type',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Early_Alert_Field_Types
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.Early_Alert_Field_Types',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_State_Plan_Early_Alerts
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.State_Plan_Early_Alerts',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_State_Plan_Impact_Funding
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.State_Plan_Impact_Funding',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_States
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.States',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Stop_Resume_Dates
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.Stop_Resume_Dates',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Sub_Type
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.Sub_Type',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Title_Type
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.Title_Type',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Type
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.Type',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_State_Plan_Service_Types
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.State_Plan_Service_Types',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_State_Plan_Service_SubTypes
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.State_Plan_Service_SubTypes',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_State_Plan
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.ksqldb.seatool.tld.State_Plan',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
