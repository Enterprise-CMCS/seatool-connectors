...
CREATE TABLE IF NOT EXISTS K_seatool_tld_aspnet_Users
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.v2.agg.aspnet_Users',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Call_Held_Reasons
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.v2.agg.Call_Held_Reasons',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Early_Alert_Fields
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.v2.agg.Early_Alert_Fields',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_EmailDistribution
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.v2.agg.EmailDistribution',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Email
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.v2.agg.Email',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Position
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.v2.agg.Position',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Priority_Review_Position
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.v2.agg.Priority_Review_Position',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Region_Access
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.v2.agg.Region_Access',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Officers
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.v2.agg.Officers',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_SPA_Type
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.v2.agg.SPA_Type',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_State_Plan_1115
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.v2.agg.State_Plan_1115',KEY_FORMAT='JSON') AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Early_Alert_Field_Types
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.v2.agg.Early_Alert_Field_Types',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Sub_Type
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.v2.agg.Sub_Type',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Title_Type
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.v2.agg.Title_Type',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_Type
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.v2.agg.Type',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_State_Plan_Service_Types
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.v2.agg.State_Plan_Service_Types',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
...
CREATE TABLE IF NOT EXISTS K_seatool_tld_State_Plan
  WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.ksql.onemac.v2.agg.State_Plan',KEY_FORMAT='JSON',WRAP_SINGLE_VALUE=FALSE) AS
