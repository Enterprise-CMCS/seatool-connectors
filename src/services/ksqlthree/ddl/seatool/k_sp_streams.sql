...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.Action_Officers',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.Action_Types',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.aspnet_Users',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.Call_Held_Reasons',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.Code_After_Init_Assess',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.Components',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.Components_StatePlans',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.Early_Alert_Field_Types',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.Early_Alert_Fields',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.EmailDistribution',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.Email',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.OCD_Review',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.Officers',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.SPA_Type',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.Position',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.Priority_Codes',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.Priority_Complexity',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.Priority_Review_Position',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.RAI',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.Region',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.Region_Access',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.State_Plan_Service_Types',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.State_Plan_1115',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.State_Plan_APD',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.State_Plan_APD_Sub_Type',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.State_Plan_Early_Alerts',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.State_Plan_Impact_Funding',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.States',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.Stop_Resume_Dates',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.Sub_Type',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.Title_Type',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.Type',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.State_Plan_Service_SubTypes',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='${param:topicNamespace}aws.seatool.cdc.debezium.SEA.dbo.State_Plan',VALUE_FORMAT='JSON',KEY_FORMAT='JSON');
